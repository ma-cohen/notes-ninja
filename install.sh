...
curl -fsSL "$REPO_URL/.cursor/commands/nn-split-project.md" -o "$DIR_NAME/.cursor/commands/nn-split-project.md"
curl -fsSL "$REPO_URL/.cursor/commands/nn-create-project.md" -o "$DIR_NAME/.cursor/commands/nn-create-project.md"
